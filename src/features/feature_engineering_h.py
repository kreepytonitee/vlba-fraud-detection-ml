...
Original file is located at
    https://colab.research.google.com/drive/1oKtW0qMQH4EBMt0I40ms_2R8GuNhOOiw
"""
...
print(f"Number of outliers in Amount Received: {df['Outlier_Amount_Received'].sum()}")
print(f"Number of outliers in Amount Paid: {df['Outlier_Amount_Paid'].sum()}")
...
df_model.to_csv('feature_engineered.csv', index=False)